...
export default function Header({
  ...
  return (
    <header className="safe-area-top fixed top-0 left-0 w-full z-50 bg-[#171f33]/60 backdrop-blur-xl border-b border-white/10 shadow-sm flex justify-between items-center px-4 sm:px-6 py-3 transition-all gap-3">
